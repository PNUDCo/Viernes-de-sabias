...
polar<- read_excel("totalesdv.xlsx")
...
levels(polar$Lugar)
polar$Categoría=factor(polar$Categoría, levels=c("Total dosis entregadas","Entregadas primeras dosis","Entregadas segundas dosis"))
